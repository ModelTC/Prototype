...
from .vit.mlp_mixer import mixer_b16_224, mixer_L16_224  # noqa: F401
from .vit.vit_base import new_deit_small_patch16_224  # noqa: F401
...
from .convnext_v2 import (  # noqa: F401
    convnextv2_atto,
    convnextv2_femto,
    convnextv2_pico,
    convnextv2_nano,
...
from .vit_timm import vit_small, vit_base, vit_small_cvst, vit_base_cvst  # noqa: F401
...
def get_model_robust_dcit():
    return {
        "alexnet": alexnet(),
        "deit_base_b16_224": deit_base_b16_224(
            drop_path=0.0, dropout=0.0, attention_dropout=0.0, qkv_bias=True
        ),
        "deit_small_b16_224": deit_small_b16_224(
            drop_path=0.0, dropout=0.0, attention_dropout=0.0, qkv_bias=True
        ),
        "deit_tiny_b16_224": deit_tiny_b16_224(
            drop_path=0.0, dropout=0.0, attention_dropout=0.0, qkv_bias=True
        ),
        ...
        "mobilenet_v3_large_x1_4_augmentation": mobilenet_v3(
            scale=1.4, dropout=0.0, mode="large"
        ),
        "mobilenet_v3_large_x1_4_augmix": mobilenet_v3(
            scale=1.4, dropout=0.0, mode="large"
        ),
        "mobilenet_v3_large_x1_4_ema": mobilenet_v3(
            scale=1.4, dropout=0.0, mode="large"
        ),
        "mobilenet_v3_large_x1_4_label_smooth": mobilenet_v3(
            scale=1.4, dropout=0.0, mode="large"
        ),
        "mobilenet_v3_large_x1_4_adv_train": mobilenet_v3(
            scale=1.4, dropout=0.0, mode="large"
        ),
        "mobilenet_v3_large_x1_4_adamw": mobilenet_v3(
            scale=1.4, dropout=0.0, mode="large"
        ),
        "mobilenet_v3_large_x1_4_dropout": mobilenet_v3(
            scale=1.4, dropout=0.2, mode="large"
        ),
        "21k_resnet50": resnet50_official(),
        "21k_vit_base_patch16_224": vit_b16_224(
            drop_path=0.0,
            dropout=0.0,
            attention_dropout=0.0,
            qkv_bias=True,
        ...
        "vit_base_patch16_224_withdrop": vit_b16_224(
            drop_path=0.1, qkv_bias=True, representation_size=768
        ),
        ...
        "mixer_B16_224_label_smooth.pth.tar": mixer_b16_224(
            drop_path=0.0, drop_path_rate=0.0
        ),
        ...
        "convnextv2_atto": convnextv2_atto(drop_path_rate=0.0),
        "convnextv2_femto": convnextv2_femto(drop_path_rate=0.0),
        "convnextv2_pico": convnextv2_pico(drop_path_rate=0.0),
        "convnextv2_nano": convnextv2_nano(drop_path_rate=0.0),
        "convnextv2_tiny": convnextv2_tiny(drop_path_rate=0.0),
        "convnextv2_base": convnextv2_base(drop_path_rate=0.0),
        "convnextv2_large": convnextv2_large(drop_path_rate=0.0),
        "convnextv2_huge": convnextv2_huge(drop_path_rate=0.0),
        # ConvNeXt models (standard)
        "convnext_tiny": convnext_tiny(drop_path_rate=0.0),
        "convnext_small": convnext_small(drop_path_rate=0.0),
        "convnext_base": convnext_base(drop_path_rate=0.0),
        "convnext_large": convnext_large(drop_path_rate=0.0),
        # ConvNeXt models with ConvStem
        "convnext_tiny_cvst": convnext_tiny_cvst(drop_path_rate=0.0),
        "convnext_small_cvst": convnext_small_cvst(drop_path_rate=0.0),
        "convnext_base_cvst": convnext_base_cvst(drop_path_rate=0.0),
        "convnext_large_cvst": convnext_large_cvst(drop_path_rate=0.0),
        # ViT models using timm (for revisiting-at compatibility)
        "vit_small": vit_small(drop_path_rate=0.0),
        "vit_base": vit_base(drop_path_rate=0.0),
        # ViT models with ConvStem
        "vit_small_cvst": vit_small_cvst(drop_path_rate=0.0),
        "vit_base_cvst": vit_base_cvst(drop_path_rate=0.0),
    }
